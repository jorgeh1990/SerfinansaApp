...
! function(a, b, c) {
  ...
  b.module("ngIdle", ["ngIdle.keepalive", "ngIdle.idle", "ngIdle.countdown", "ngIdle.title", "ngIdle.localStorage"]), b.module("ngIdle.keepalive", []).provider("Keepalive", function() {
    ...
    this.autoResume = function(b) {
      ...
      function l() {
        a.keepalive && (t.running && i.ping(), i.start())
      }
      ...
      function n() {
        t.idling = !t.idling;
        var b = t.idling ? "IdleStart" : "IdleEnd";
        t.idling ? (g.$broadcast(b), m(), a.timeout && (t.countdown = a.timeout, o(), t.timeout = e(o, 1e3, a.timeout, !1))) : (l(), g.$broadcast(b)), e.cancel(t.idle)
      }

      function o() {
        if (t.idling) {
          if (t.countdown <= 0) return void p();
          g.$broadcast("IdleWarn", t.countdown), t.countdown--
        }
      }

      function p() {
        m(), e.cancel(t.idle), e.cancel(t.timeout), t.idling = !0, t.running = !1, t.countdown = 0, g.$broadcast("IdleTimeout")
      }
      ...
      var t = {
        ...
        v = {
          ...
          watch: function(b) {
            e.cancel(t.idle), e.cancel(t.timeout);
            var c = a.timeout ? a.timeout : 0;
            b || s(new Date((new Date).getTime() + 1e3 * (a.idle + c))), t.idling ? n() : t.running || l(), t.running = !0, t.idle = e(n, 1e3 * a.idle, 0, !1)
          },
          unwatch: function() {
            e.cancel(t.idle), e.cancel(t.timeout), t.idling = !1, t.running = !1, s(null), m()
          },
          interrupt: function(b) {
            return t.running ? a.timeout && this.isExpired() ? void p() : void((b || "idle" === a.autoResume || "notIdle" === a.autoResume && !t.idling) && this.watch(b)) : void 0
          }
        },
        w = {
          clientX: null,
      ...
      if (h.find("html").on(a.interrupt, function(a) {
          "mousemove" === a.type && a.originalEvent && 0 === a.originalEvent.movementX && 0 === a.originalEvent.movementY || ("mousemove" !== a.type || w.hasMoved(a)) && v.interrupt()
        }), a.windowInterrupt)
        for (var x = a.windowInterrupt.split(" "), y = function() {
            v.interrupt()
          }, z = 0; z < x.length; z++) k.addEventListener ? k.addEventListener(x[z], y, !1) : k.attachEvent(x[z], y);
      var A = function(a) {
      ...
      return k.addEventListener ? k.addEventListener("storage", A, !1) : k.attachEvent("onstorage", A), v
    }]
